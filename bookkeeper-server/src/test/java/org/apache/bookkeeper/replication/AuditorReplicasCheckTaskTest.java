...
public class AuditorReplicasCheckTaskTest extends BookKeeperClusterTestCase {
    ...
    @Test
    void replicasCheck() throws BKException, InterruptedException {
        ...
        assertEquals(1, ((TestStatsProvider.TestOpStatsLogger)
                statsLogger.getOpStatsLogger(ReplicationStats.REPLICAS_CHECK_TIME)).getSuccessCount(), "REPLICAS_CHECK_TIME");
    }
}
